...
from .models import CustomUser, Admin, DataTable, UserProfile, Subscription, LogReport, PlanTable, UserDataTableStatus,FAQ,Feedback,PaymentHistory
...
# Registering the Payment History
